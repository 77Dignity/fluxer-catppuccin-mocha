...
## How to use this? 
#### In fluxer head over to: 
```
User Settings > Look and Feel > Custom Theme Tokens
```
and paste the text from the following in: 

[Up to Date Catppucin Mocha](https://spacesnek.github.io/fluxer-catppuccin-mocha/style.css)
